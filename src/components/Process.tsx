const steps = [
  ...
  { n: "02", title: "Strategy", desc: "Creating structure, user flows, and content direction." },
  {
    n: "03",
    title: "Structure",
    desc: "Mapping page architecture and component structure focused on trust and clarity.",
  },
  {
    n: "04",
    title: "Development",
    desc: "Building a fast, responsive site in React and TypeScript, ready to extend.",
  },
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28 lg:py-40">
        <div className="max-w-xl">
          ...
          <p className="mt-5 text-base leading-[1.7] text-muted-foreground sm:text-lg">
            A clear, collaborative workflow built to remove friction and deliver websites that
        ...
        <div className="relative mt-20 hidden lg:block">
          <div
            aria-hidden
            className="pointer-events-none absolute left-0 right-0 top-[18px] h-px bg-gradient-to-r from-transparent via-border to-transparent"
          />
        ...
        <div className="relative mt-16 lg:hidden">
          <div
            aria-hidden
            className="pointer-events-none absolute left-[17px] top-2 bottom-2 w-px bg-gradient-to-b from-border via-border to-transparent"
          />
